...
$string['todate'] = 'to';
$string['topic'] = 'Topic';
$string['unpin'] = 'Unpin comment';
$string['unpinpage'] = 'Unpin all comments';
$string['userspercron'] = 'Users per cron';
$string['userspercrondesc'] = 'Digests of new comments are sent out per cron, you may limit the number of processed users here. Setting up a value of 0 means no limit. Please adjust the execution interval of the scheduled task (Process digests), too: {$a}';
